...
class IKEAScraper:
    ...
    #def input(self):
    #    job = input("Kata kunci kerja")
      #  lokasi = input("Lokasi tempat")
     #   
    #    return job, lokasi
    ...
    def get_category_urls(self):
        job = input("Kata kunci kerja")
        lokasi = input("Lokasi tempat")
        self.driver.get(f"https://id.indeed.com/jobs?q={job}&l={lokasi}") #launch the browser bot to the url
...
############################################################
##Kode dibawah harus diedit total sesuai dengan kebutuhan###
############################################################
...
########################################
###Ini juga harus dirubah disesuaikan###
########################################
